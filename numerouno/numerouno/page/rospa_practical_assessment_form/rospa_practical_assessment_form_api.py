...
from numerouno.numerouno.page.rospa_practical_assessment_form.rospa_practical_assessment_form import (
	cancel_form,
	get_form_data,
	get_group_students,
	prepare_group,
...
def _render_form_html(doc_data):
	...
	return frappe.render_template(
		"numerouno/numerouno/print_format/rospa_practical_assessment/rospa_practical_assessment.html",
		{"doc": doc},
	)
