...
from numerouno.numerouno.page.off_road_practical_assessment_form.off_road_practical_assessment_form import (
	cancel_form,
	get_form_data,
	get_group_students,
	prepare_group,
...
def _render_form_html(doc_data):
	...
	return frappe.render_template(
		"numerouno/numerouno/print_format/off_road_practical_assessment/off_road_practical_assessment.html",
		{"doc": doc},
	)
