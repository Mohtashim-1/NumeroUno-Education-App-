...
from numerouno.numerouno.page.lv_practical_assessment_form.lv_practical_assessment_form import (
	cancel_form,
	get_form_data,
	get_group_students,
	prepare_group,
...
def _render_form_html(doc_data):
	...
	return frappe.render_template(
		"numerouno/numerouno/print_format/lv_practical_assessment/lv_practical_assessment.html",
		{"doc": doc},
	)
