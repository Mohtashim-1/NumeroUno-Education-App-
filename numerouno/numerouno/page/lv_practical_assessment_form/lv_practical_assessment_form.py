...
from numerouno.numerouno.doctype.lv_practical_assessment.lv_practical_assessment import (
	apply_template,
)
...
def _serialize_doc(doc):
	return {
		...
		"naming_series": doc.naming_series or "LVP-.YYYY.-",
...
def _get_or_create_doc(student_group, student, assessment_date=None):
	...
	if existing:
		return frappe.get_doc("LV Practical Assessment", existing)
	...
	doc = frappe.new_doc("LV Practical Assessment")
...
def get_form_data(docname=None, student_group=None, student=None):
	...
	if docname:
		doc = frappe.get_doc("LV Practical Assessment", docname)
